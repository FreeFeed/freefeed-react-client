...
const payloadOneSub = {
  users: {
    id: '86ad24d8-0ca0-42af-905f-743d3a472eb6',
    username: 'clbn12',
    type: 'user',
    screenName: 'clbn12',
    email: 'clbn12@clbn12.com',
    isPrivate: '0',
    frontendPreferences: {},
    ...
    administrators: ['86ad24d8-0ca0-42af-905f-743d3a472eb6'],
    pendingGroupRequests: false,
    subscriptions: [
      '7f2b907a-edc3-4011-bbe8-8979408decef',
      '540a5c2b-10d8-4662-8194-7655592653da',
      '008d3f1e-f1b5-4395-8b31-30f2d842b3dc',
    ],
  },
  admins: [
    {
  ...
  subscriptions: [
    {
      id: '7f2b907a-edc3-4011-bbe8-8979408decef',
      name: 'Likes',
      user: 'd49b39eb-b8f1-4e2e-90fc-7be68c6db34f',
    },
    {
      id: '540a5c2b-10d8-4662-8194-7655592653da',
      name: 'Comments',
      user: 'd49b39eb-b8f1-4e2e-90fc-7be68c6db34f',
    },
    {
...
const payloadTwoSubs = {
  users: {
    ...
    pendingGroupRequests: false,
    subscriptions: [
      '60265209-1439-4a54-8491-00749a94a195',
      '5d5fb359-1f8f-4e95-a16d-c5ae9b51dd47',
      '1d0f5fb9-71f3-45ee-bec2-356e496612ca',
      '7f2b907a-edc3-4011-bbe8-8979408decef',
      '540a5c2b-10d8-4662-8194-7655592653da',
      '008d3f1e-f1b5-4395-8b31-30f2d842b3dc',
    ],
  ...
  subscribers: [
    {
      ...
      isRestricted: '0',
      profilePictureLargeUrl:
        'https://frf-api.applied.creagenics.com/profilepics/7be65d5e-ed97-4d8e-9298-385f974891e6_75.jpg',
      profilePictureMediumUrl:
        'https://frf-api.applied.creagenics.com/profilepics/7be65d5e-ed97-4d8e-9298-385f974891e6_50.jpg',
    },
    {
      id: 'd49b39eb-b8f1-4e2e-90fc-7be68c6db34f',
      username: 'apples',
  ...
  subscriptions: [
    {
      id: '60265209-1439-4a54-8491-00749a94a195',
      name: 'Comments',
      user: '66d2c0e2-ce15-4c73-bbc7-3205e7f2e259',
    },
    {
    ...
    {
      id: '1d0f5fb9-71f3-45ee-bec2-356e496612ca',
      name: 'Likes',
      user: '66d2c0e2-ce15-4c73-bbc7-3205e7f2e259',
    },
    {
