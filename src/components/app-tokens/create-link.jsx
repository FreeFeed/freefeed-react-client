...
export default function CreateLink() {
  ...
  return (
    <>
      ...
      <p>
        Here you can create a magic link that fully or partially pre-fills
        the “New application token” form for your application users.
      </p>
      <p>
        <Link to="/settings/app-tokens/scopes">More about the token access rights and scopes <Icon icon={faAngleRight} /></Link>
      </p>
      ...
      <div className="alert alert-info">
        ...
        <TextCopier text={`${location.origin}/settings/app-tokens/create${query !== '' ? `?${query}` : ''}`} />
      </div>
    </>
  );
}
