  ...
  <div className="box">
    ...
    <div className="box-body">
      ...
      <p>FreeFeed is a social network that enables you to discover and discuss
        the interesting stuff your friends find on the web.
      </p>
      ...
      <p>After Facebook had acquired FriendFeed and announced its plan to shut
        ...
        FriendFeed users decided to build an open-source free-for-all replacement.
      </p>
      ...
      <p>
        FreeFeed is an open-source project. We are <Link to="/dev">looking for volunteers</Link> to help us with the development of FreeFeed.net.
      </p>

      <h3>Important pages</h3>

      <p><Link to="/support">https://freefeed.net/support</Link> –
        Tech support (we speak English, Russian as well as some other languages :))
      </p>
      ...
      <p>
        After launching a <a href="https://www.indiegogo.com/projects/freefeed-v-1" target="_blank">successful crowdfunding campaign</a> in December 2015, the platform is now being
        actively developed. It is being used by <Link to="/about/stats">hundreds of people</Link> now, even
        though the work is still underway.
      </p>
