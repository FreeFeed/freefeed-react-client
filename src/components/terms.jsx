  ...
  <div className="box">
    ...
    <div className="box-body">
      ...
      <p>Please read these Terms of Service (&quot;Terms&quot;, &quot;Terms of Use&quot;) carefully before using
        ...
        operated by FreeFeed MT&Uuml; (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;).
      </p>
      ...
      <p>Without advance notice and at any time, we may, for violations of these Terms or for any other reason
        ...
        remove any of your User Content from the Service.
      </p>
      ...
      <p>With respect to photos, graphics, audio, video and other content you make available on the Service, you grant
        ...
        FreeFeed MT&Uuml; removes such Content from the Service.
      </p>
      ...
      will remain the exclusive property of FreeFeed MT&Uuml; and its licensors. The Service is protected by copyright,
      trademark, and other laws of both Estonia and foreign countries. Our trademarks and trade dress may not be used
      in connection with any product or service without the prior written consent of FreeFeed MT&Uuml;.
      </p>
      ...
      <p>FreeFeed MT&Uuml; has no control over, and assumes no responsibility for, the content, privacy policies, or
        practices of any third party web sites or services. You further acknowledge and agree that FreeFeed MT&Uuml; shall
      ...
      <p>In no event shall FreeFeed MT&Uuml;, nor its directors, employees, partners, agents, suppliers, or affiliates, be
