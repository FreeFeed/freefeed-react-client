  ...
  <div className="box">
    ...
    <div className="box-body">
      ...
      <p>Please read these Terms of Service (&quot;Terms&quot;, &quot;Terms of Use&quot;) carefully before using
        ...
        operated by FreeFeed MT&Uuml; (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;).</p>
      ...
      <p>With respect to photos, graphics, audio, video and other content you make available on the Service, you grant
        ...
        FreeFeed MT&Uuml; removes such Content from the Service.</p>
      ...
      in connection with any product or service without the prior written consent of FreeFeed MT&Uuml;.</p>
