...
import { unsubscribeFromGroup, makeGroupAdmin, unadminGroupAdmin } from '../redux/action-creators';
...
function selectState(state, ownProps) {
  ...
  const amILastGroupAdmin =
    groupAdmins.find((u) => u.username == state.user.username) != null && groupAdmins.length == 1;
