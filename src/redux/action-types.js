...
export const ACCEPT_GROUP_REQUESTS = 'ACCEPT_GROUP_REQUESTS'
export const REJECT_GROUP_REQUESTS = 'REJECT_GROUP_REQUESTS'
export const ACCEPT_USER_REQUESTS = 'ACCEPT_USER_REQUESTS'
export const REJECT_USER_REQUESTS = 'REJECT_USER_REQUESTS'
