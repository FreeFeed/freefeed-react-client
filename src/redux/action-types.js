...
export const LINK_OAUTH_ACCOUNT = 'LINK_OAUTH_ACCOUNT';
export const UNLINK_OAUTH_ACCOUNT = 'UNLINK_OAUTH_ACCOUNT';
...
export const GET_FACEBOOK_FRIENDS = 'GET_FACEBOOK_FRIENDS';
export const GET_ALL_FACEBOOK_FRIENDS = 'GET_ALL_FACEBOOK_FRIENDS';
